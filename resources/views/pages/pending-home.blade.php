            ...
            <div class="col-xl-4 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                    <h5 class="card-title text-uppercase text-muted mb-0"><a href="{{ route('home') }}">Received</a></h5>
            ...
            <div class="col-xl-4 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                    <h5 class="card-title text-uppercase text-muted mb-0"><a href="{{ route('pages.pending-home') }}"><b>Pending</b></a></h5>
                      <span class="h2 font-weight-bold mb-0">2,356</span>
                    </div>
                    <div class="col-auto">
...
<tr>
    ...
    <th><span class="h5 font-weight-bold mb-0">Department</span></th></th>
    <th><span class="h5 font-weight-bold mb-0">Leave Date</span></th></th>
    <th><span class="h5 font-weight-bold mb-0">Reason</span></th></th>
    <th><span class="h5 font-weight-bold mb-0">Status</span></th></th>
  </tr>
</thead>
</table>
</tbody>
